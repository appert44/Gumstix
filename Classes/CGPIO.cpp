 ...
 */
CGPIO :: CGPIO (char * sDevicePath, int iDirection, bool bDefaultValue)
{
	// I/O Mode
	m_iMode = IO_MODE;
...
int CGPIO :: Open()
{
	...
	//cout << "ERR_CGPIO_OPEN_SPECIFIED_PATH" << ERR_CGPIO_OPEN_SPECIFIED_PATH << endl ;
