...
class CGPIO : public CIODevice
{
	...
	int				m_iMode;									/**< \brief Boolean which indicates the using mode of the Gpio (I/O Mode, or IT Mode). */
	int 			m_iDirection;								/**< \brief Boolean which indicates the direction of th Gpio in I/O Mode. */
	...
	CGPIO (char * sDevicePath, int iDirection, bool bDefaultValue);
